...
*/
#define	node1can1	0x726L //rxCAN1()
#define node2can1	0x201L//txCAN2()
#define node1can2	0x00L //change txCAN1() Sender node ID high priority message
#define node2can2	0x202L //rxCAN2()
...
loop() {
    ...
    int i;
        ...
        {               
            ...
            {
            txCAN2(node2can1);//check address
            delay(100);
            rxCAN2();
...
txCAN1(uint32_t rxnode) {
  ...
  if (message != NULL) {
    ...
    message->data[0]        = 0x01; //enter operational mode change
    message->data[1]        = 0x26; // node ID change or 0x26
   // message->data[2]        = 0x32;
   // message->data[3]        = 0x33;
   // message->data[4]        = 0x34;
   // message->data[5]        = 0x35;
...
rxCAN1(void) {
   ...
   * as an ASCII character on the serial monitor. */
   ...
   Serial.println(int(message->data[0]));
  /*
   Serial.print(byte(message->data[1]));
   Serial.print(byte(message->data[2]));
   Serial.print(byte(message->data[3]));
   Serial.print(byte(message->data[4]));
   Serial.print(byte(message->data[5]));
   Serial.print(byte(message->data[6]));
   Serial.print(byte(message->data[7]));
  */ 
