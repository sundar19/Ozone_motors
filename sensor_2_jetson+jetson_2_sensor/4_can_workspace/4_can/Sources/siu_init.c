...
void siu_portE_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[64].R = 0x0101;
             /* User Assigned Signal Name : PE0_INPUT  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[68].R = 0x0201;
             /* User Assigned Signal Name : PE4_OUTPUT  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[69].R = 0x0201;
             /* User Assigned Signal Name : PE5_OUTPUT  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[70].R = 0x0201;
             /* User Assigned Signal Name : PE6_OUTPUT  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[71].R = 0x0201;
             /* User Assigned Signal Name : PE7_OUTPUT  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[72].R = 0x0601;
             /* User Assigned Signal Name : PE8_CAN2_TX  */
             /*	Selected Function : CNTX_2          */
             /*	Output Buffers : Enabled          */
             /*	Input Buffers : Disabled          */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[73].R = 0x0101;
             /* User Assigned Signal Name : PE9_CAN2_RX  */
             /*	Selected Function : PE9 I          */
             /*	Output Buffers : Disabled         */
             /*	Input Buffers : Enabled           */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
...
void siu_portF_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[88].R = 0x0601;
             /* User Assigned Signal Name : PF8_CAN3_TX  */
             /*	Selected Function : CNTX_3          */
             /*	Output Buffers : Enabled          */
             /*	Input Buffers : Disabled          */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[89].R = 0x0101;
             /* User Assigned Signal Name : PF9_CAN3_RX  */
             /*	Selected Function : PF9 I          */
             /*	Output Buffers : Disabled         */
             /*	Input Buffers : Enabled           */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
...
void siu_portH_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[112].R = 0x0101;
             /* User Assigned Signal Name : DSPI1_DATA_IN  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[113].R = 0x0A01;
             /* User Assigned Signal Name : DSPI1_DATA_OUT  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[114].R = 0x0A01;
             /* User Assigned Signal Name : DSPI1_CLK  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[115].R = 0x0A01;
             /* User Assigned Signal Name : DSPI1_CS0  */
...
/*-----------------------------------------------------------*/
               SIU.PSMI[2].R = 0x02;
                /*Function Pad Selected CAN3_RXD :- PCR89*/
