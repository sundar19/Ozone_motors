...
use 3_can_workspace for NXP , sensor_can for chipkit , AirQ_Press_T_H_can for arduino nano , mpu6050_thresh_can for xiao (values are sent only if there is a change in acceleration) , socket_client_listen.py for Jetson
